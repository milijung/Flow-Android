    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(roomDb != null){
            ...
            if(categoryLength == 0){
                ...
                roomDb.CategoryDao().insert(Category("주거·통신",
                    R.drawable.ic_category_living,1,1,false))
                roomDb.CategoryDao().insert(Category("교통관련",
                    R.drawable.ic_category_traffic,1,2,false))
                roomDb.CategoryDao().insert(Category("생필품", R.drawable.ic_category_market,1,3,false))
                roomDb.CategoryDao().insert(Category("나를 위한",
                    R.drawable.ic_category_formeexpense,1,4,false))
                roomDb.CategoryDao().insert(Category("선물준비",
                    R.drawable.ic_category_present,1,5,false))
                roomDb.CategoryDao().insert(Category("자기계발",
                ...
                roomDb.CategoryDao().insert(Category("의료·건강",
                    R.drawable.ic_category_medical,1,10,false))
                roomDb.CategoryDao().insert(Category("오락·취미",
                ...
                roomDb.CategoryDao().insert(Category("자산이동",
                    R.drawable.ic_category_assetmovement,1,13,false))
                roomDb.CategoryDao().insert(Category("기타지출",
                    R.drawable.ic_category_others,1,14,false))
                ...
                roomDb.CategoryDao().insert(Category("장학금",
                    R.drawable.ic_category_income_user,2,1,true))
                roomDb.CategoryDao().insert(Category("이자",
                    R.drawable.ic_category_income_user,2,2,true))
            }
