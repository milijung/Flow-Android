...
class CalendarAdapter(private val dayList:ArrayList<CalendarData>, private val selectedDate: LocalDate): RecyclerView.Adapter<CalendarAdapter.ItemViewHolder>(){
    ...
    class ItemViewHolder(binding:ItemCalendarBinding):RecyclerView.ViewHolder(binding.root){
